-- Spec §2.3: used_capacity = (active_bookings_last_30min / online_providers) × 100 %
-- All in-flight statuses count only when created within the rolling 30-minute window.
...
comment on function public.compute_used_capacity(text, text) is
  'Spec §2.3: active bookings in last 30 min / online providers in pricing area.';
