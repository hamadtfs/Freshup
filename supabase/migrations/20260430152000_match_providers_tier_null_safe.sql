-- Treat NULL/blank dispatch_performance_tier as 'gold' for tier-wave matching.
-- Otherwise those rows fail `= 'gold'|'silver'|'bronze'` and every wave returns zero providers.
