-- Allow at-provider matching even when provider location is missing.
-- For at_provider/provider mode only, providers without coordinates are kept with distance 0.
