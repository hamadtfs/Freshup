-- Short-circuit dispatch tick when there are no open/searching orders.
-- Avoids ~28,800 no-op net.http_post → net._http_response rows/day when idle.
--
-- Book-confirm still runs wave 0 via the Next.js API directly; this only
-- gates the pg_cron → Edge Function hop.
